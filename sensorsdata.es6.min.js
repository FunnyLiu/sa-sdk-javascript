...
(function() {
  ...
  var r = t.JSON,
    ...
    i = (function n(r, s) {
      ...
      "object" == typeof _ &&
        _ &&
        ((s.stringify = _.stringify), (s.parse = _.parse));
      var p,
        f = o.prototype,
        g = f.toString,
        h = f.hasOwnProperty;
      ...
      if (
        ...
        (y["bug-string-char-index"] = y["date-serialization"] = y.json = y[
          "json-stringify"
        ] = y["json-parse"] = null),
        !y("json"))
      ) {
        ...
        if (!y("json-stringify") && !y("date-serialization")) {
            ...
            j = function(e) {
              ...
              if (v)
                ...
                t = function(e) {
                  ...
                  for (s = l((a - p(r, 0)) / 30.42); p(r, s + 1) <= a; s++);
                  (a = 1 + a - p(r, s)),
          ...
          if (y("json-stringify") && !y("date-serialization")) {
            ...
            var D = function(e) {
              ...
              A = function(e, t, r, s, a, i, n) {
                var o, c, u, _, f, h, v, y, S;
                if (
                  (m(function() {
                    o = t[e];
                  }),
        ...
        if (!y("json-parse")) {
          var x,
            ...
            U = function() {
              for (var e, t, r, s, a, i = $, n = i.length; x < n; )
                switch ((a = i.charCodeAt(x))) {
                  case 9:
                  case 10:
                  case 13:
                  case 32:
                  ...
                  case 58:
                  case 44:
                    return (e = S ? i.charAt(x) : i[x]), x++, e;
                  case 34:
                    for (e = "@", x++; x < n; )
                      if ((a = i.charCodeAt(x)) < 32) T();
                      else if (92 == a)
                        switch ((a = i.charCodeAt(++x))) {
                          case 92:
                          case 34:
                  ...
                  default:
                    if (
                      ((t = x),
                      45 == a && ((s = !0), (a = i.charCodeAt(++x))),
                      a >= 48 && a <= 57)
                    ) {
                      for (
                        48 == a &&
                          (a = i.charCodeAt(x + 1)) >= 48 &&
                          a <= 57 &&
                          T(),
                          s = !1;
                        x < n && (a = i.charCodeAt(x)) >= 48 && a <= 57;
                        x++
                      );
                      ...
                      if (101 == (a = i.charCodeAt(x)) || 69 == a) {
                        for (
                          (43 != (a = i.charCodeAt(++x)) && 45 != a) || x++,
                            r = x;
                          r < n && !((a = i.charCodeAt(r)) < 48 || a > 57);
                          r++
                        );
                    ...
                    if ("fals" == o && 101 == i.charCodeAt(x + 4))
                      return (x += 5), !1;
  ...
  (function() {
    var e,
      ...
      d = i.hasOwnProperty,
      c = (a.bind, s.forEach),
      l = (s.indexOf, Array.isArray),
      u = {},
      p = (_.each = function(e, t, r) {
        if (null == e) return !1;
        if (c && e.forEach === c) e.forEach(t, r);
          ...
          for (var i in e)
            if (d.call(e, i) && t.call(r, e[i], i, e) === u) return !1;
      });
    (_.map = function(e, t) {
      var r = [];
      return null == e
      ...
      (_.extend = function(e) {
        return (
          p(n.call(arguments, 1), function(t) {
            for (var r in t) d.call(t, r) && void 0 !== t[r] && (e[r] = t[r]);
          }),
          e
        );
      }),
      ...
      (_.isDecodeURI = function(e, t) {
        return e ? _.decodeURI(t) : t;
      }),
      ...
      (_.getRandom = function() {
        if ("function" == typeof Uint32Array) {
          ...
          if (
            ...
            _.isObject(e) && e.getRandomValues)
          ) {
            var t = new Uint32Array(1);
            return e.getRandomValues(t)[0] / Math.pow(2, 32);
          }
        }
        return _.getRandomBasic(1e19) / 1e19;
      }),
      ...
      (_.searchObjString = function(e) {
        ...
        _.isObject(e) &&
          _.each(e, function(r, s) {
            _.isObject(r)
              ? _.searchObjString(e[s])
              : _.isString(r) &&
                (e[s] = _.formatString(
                  r,
                  _.indexOf(t, s) > -1 ? 1024 : sd.para.max_string_length
                ));
          });
      }),
        ...
        (function(t, r, s) {
          ...
          if (
            (_.isObject(sd.para.heatmap) &&
              "undefined" == typeof sd.para.heatmap.useCapture &&
              "click" === r &&
              (a = !0),
            ...
            t[i] = (function(t, r, s) {
              return function(a) {
                if (!(a = a || e(window.event))) return undefined;
      ...
      (_.cookie = {
        ...
        set: function(e, t, r, s) {
          ...
          if (
            ...
            var o = _.getCurrentDomain(location.href);
            "url\u89e3\u6790\u5931\u8d25" === o && (o = ""),
              (a = o ? "; domain=" + o : "");
          }
          if (0 !== r) {
            ...
            "s" === String(r).slice(-1)
              ...
              (i = "; expires=" + d.toGMTString());
          }
          function c(e) {
            return !!e && e.replaceAll(/\r\n/g, "");
          }
          sd.para.is_secure_cookie && (n = "; secure");
          var l = "",
            u = "",
            p = "";
          e && (l = c(e)),
            ...
            l &&
              u &&
              (document.cookie =
                l + "=" + encodeURIComponent(u) + i + "; path=/" + p + n);
        },
        encrypt: function(e) {
          return "data:enc;" + _.rot13obfs(e);
        },
        decrypt: function(e) {
          return (e = e.substring("data:enc;".length)), (e = _.rot13defs(e));
        },
        resolveValue: function(e) {
          return (
            _.isString(e) &&
              0 === e.indexOf("data:enc;") &&
              (e = _.cookie.decrypt(e)),
            e
          );
        },
        remove: function(e, t) {
      ...
      (_.getEleInfo = function(e) {
        ...
        return (
          ...
          ((s = _.strip_empty_properties(s)).$url = _.isDecodeURI(
      ...
      (_.ajax = function(e) {
        ...
        (e.timeout = e.timeout || 2e4),
          (e.credentials =
            "undefined" == typeof e.credentials || e.credentials);
        var r = _.xhr(e.cors);
        if (!r) return !1;
      ...
      (_.URL = function(e) {
        ...
        if (
          ...
          (r = new URL(e)).searchParams ||
            (r.searchParams = ((t = _.getURLSearchParams(r.search)),
            {
              get: function(e) {
                return t[e];
              },
          ...
          (r.hash = ""),
            ...
            (r.search = s._values.QueryString
              ? "?" + s._values.QueryString
              : ""),
            ...
            (r.searchParams = (function() {
              var e = _.getURLSearchParams("?" + s._values.QueryString);
              return {
                get: function(t) {
                  return e[t];
                },
        ...
        if (_.isArray(r) && r.length >= 2 && !/^(\d+\.)+\d+$/.test(t))
          for (var s = "." + r.splice(r.length - 1, 1); r.length > 0; )
            if (
              ...
              (document.cookie =
                "sensorsdata_domain_test=true; path=/; domain=" + s),
      ...
      (_.rot13obfs = function(e, t) {
        ...
        for (
          var r = (e = String(e)).split(""), s = 0, a = r.length;
          s < a;
          s++
        ) {
      ...
      (_.getDomBySelector = function(e) {
        ...
        return (t = (function s(e) {
          ...
          try {
            t = (function(e, t) {
              ...
              if (0 === e.indexOf("#"))
                ...
                var n = Number(i[1]);
                if (!(_.isElement(t) && t.children && t.children.length > 0))
                  return null;
          ...
          return t && _.isElement(t) ? s(t) : null;
        })()) && _.isElement(t)
          ? t
          : null;
      }),
      ...
      (_.listenPageState = function(e) {
        ({
          visibleHandle: _.isFunction(e.visible) ? e.visible : function() {},
          hiddenHandler: _.isFunction(e.hidden) ? e.hidden : function() {},
      ...
      (_.isSupportBeaconSend = function() {
        ...
        if (
          ...
          var s = (r.match(/os [\d._]*/gi) + "")
            ...
            .replace(/_/gi, ".")
            .split(".");
          "undefined" == typeof e.safari && (e.safari = s[0]),
            s[0] && s[0] < 13
              ? (e.chrome > 41 ||
                  e.firefox > 30 ||
                  e.opera > 25 ||
      ...
      (_.secCheck = {
        isHttpUrl: function(e) {
          ...
          return !1 !== /^https?:\/\/.+/.test(e) || (sd.log("Invalid URL"), !1);
        },
  ...
  (sd.addPropsHook = function(e) {
    sd.para.preset_properties &&
      ...
      (e.properties.$url = _.isDecodeURI(
        sd.para.url_is_decode,
  ...
  autoTrackSinglePage: function(e, t) {
    ...
    function a(e, t) {
      sd.track(
        ...
        _.extend(
          {
            $referrer: _.isDecodeURI(sd.para.url_is_decode, r),
...
(sd.quick = function() {
    ...
    return (
      sd.para.preset_properties.latest_referrer &&
        ...
        (s.$latest_referrer_host =
          "" === s.$latest_referrer ? "" : _.getHostname(s.$latest_referrer)),
      s
    );
  }),
  (sd.detectMode = function() {
          ...
          if ("v-track-mode" === e.data.type) {
            if (e.data.data && e.data.data.isVtrack)
              if (
                ...
                var r = ((s = e.data.data.userURL),
                _.secCheck.isHttpUrl(s)
                  ? _.secCheck.removeScriptProtocol(s)
                  : (sd.log(
                      "\u53ef\u89c6\u5316\u6a21\u5f0f\u68c0\u6d4b URL \u5931\u8d25"
                    ),
                    !1));
    ...
    sd.para.heatmap &&
      ...
      _.isObject(sd.para.heatmap.collect_tags) &&
      _.each(sd.para.heatmap.collect_tags, function(e, t) {
              ...
              var t = function(t) {
                (t = t || {}),
                  e !== location.href &&
                    ...
                    (e = _.isDecodeURI(sd.para.url_is_decode, e)),
                    sd.quick(
                      "autoTrack",
                      _.extend(
                        {
  ...
  (BatchSend.prototype = {
    ...
    removePendingItems: function(e) {
      if (!1 !== _.isArray(e)) {
        this.sendingItemKeys.length &&
          (this.sendingItemKeys = _.filter(this.sendingItemKeys, function(t) {
...
var dataSend = {
  getSendUrl: function(e, t) {
    var r = _.base64Encode(t),
      s = "crc=" + _.hashCode(r);
    return -1 !== e.indexOf("?")
      ? e + "&data=" + encodeURIComponent(r) + "&ext=" + encodeURIComponent(s)
      : e + "?data=" + encodeURIComponent(r) + "&ext=" + encodeURIComponent(s);
  },
...
(sd.sendState = sendState),
  ...
  (sendState.getSendCall = function(e, t, r) {
    ...
    sd.bridge.dataSend(a, this, r), sd.log(s);
  }),
...
(sd.saEvent = saEvent),
  (saEvent.checkOption = {
    ...
    propertiesMust: function(e) {
      return (
        _.strip_sa_properties(e),
        e === undefined || !_.isObject(e) || _.isEmptyObject(e)
          ? (sd.log(
              "properties\u5fc5\u987b\u662f\u5bf9\u8c61\u4e14\u6709\u503c"
            ),
            !0)
  ...
  (saEvent.send = function(e, t) {
    ...
    _.isObject(e) &&
      ...
      e.properties.$lib_method &&
        ((r.lib.$lib_method = e.properties.$lib_method),
      ...
      (e.type && "profile" === e.type.slice(0, 7)) ||
        ...
        sd.para.preset_properties.latest_search_keyword &&
          ...
          (r.properties.$latest_search_keyword = "\u53d6\u503c\u5f02\u5e38"),
    ...
    var s = sd.vtrackcollect.customProp.getVtrackProps(
      JSON.parse(JSON.stringify(r))
    );
    _.isObject(s) &&
      !_.isEmptyObject(s) &&
      (r.properties = _.extend(r.properties, s)),
      _.parseSuperProperties(r),
    ...
    saNewUser.checkIsAddSign(r),
      ...
      !0 === sd.para.debug_mode
        ...
        : sd.sendState.getSendCall(r, a, t);
  }),
...
var store = (sd.store = {
    ...
    save: function() {
      ...
      sd.para.encrypt_cookie && (t = _.cookie.encrypt(t)),
        _.cookie.set(this.getCookieName(), t, 73e3, sd.para.cross_subdomain);
    },
    ...
    init: function() {
      ...
      null === (t = _.cookie.resolveValue(t))
  ...
  saNewUser = {
    ...
    setDeviceId: function(e) {
      var t = null,
        ...
        s = {};
      null != (r = _.cookie.resolveValue(r)) &&
        _.isJSONString(r) &&
        ...
        !0 === sd.para.cross_subdomain
          ...
          : ((s.$device_id = t),
            (s = JSON.stringify(s)),
            sd.para.encrypt_cookie && (s = _.cookie.encrypt(s)),
            _.cookie.set("sensorsdata2015jssdkcross", s, null, !0)),
    ...
    checkIsFirstLatest: function() {
      ...
      if (
        ...
        _.each(sd.para.preset_properties, function(t, r) {
            ...
            if ("utm" !== r && "url\u89e3\u6790\u5931\u8d25" === e)
              ...
              switch (r) {
                case "traffic_source_type":
                  ...
                  break;
                case "referrer":
                  a.$latest_referrer = _.isDecodeURI(
                    sd.para.url_is_decode,
                ...
                case "search_keyword":
                  ...
                  break;
                case "landing_page":
                  a.$latest_landing_page = _.isDecodeURI(
                    sd.para.url_is_decode,
                    location.href
                  );
                  break;
          ...
          else if ("wx_ad_click_id" == r && sd.store._state.props && !1 === t) {
            _.each(
              [
      ...
      if (
        ...
        sd.bridge.is_verify_success
          ? (window.webkit.messageHandlers.sensorsdataNativeTracker.postMessage(
              JSON.stringify({
                ...
                data: _.extend({ server_url: sd.para.server_url }, s),
              })
            ),
            "function" == typeof r && r())
        ...
        sd.bridge.is_verify_success
          ? (SensorsData_APP_New_H5_Bridge.sensorsdata_track(
              JSON.stringify(_.extend({ server_url: sd.para.server_url }, s))
            ),
            "function" == typeof r && r())
          : sd.para.app_js_bridge.is_send
...
var heatmap = (sd.heatmap = {
  ...
  getTargetElement: function(e, t) {
    ...
    var a = r.parentNode,
      i = this.hasElement(t.originalEvent || t),
      n = sd.para.heatmap.track_attr,
      o = this.otherTags;
    if (
      "a" === s ||
      "button" === s ||
    ...
    if (this.isStyleTag(s) && sd.para.heatmap.collect_tags.div) {
      var d = this.getCollectableParent(r);
      if (d && this.isDivLevelValid(d)) return d;
    }
    return null;
  },
  ...
  getEleDetail: function(e) {
    ...
    return _.isNumber(s) && (r.$element_position = s), r;
  },
  start: function(e, t, r, s, a) {
    var i = _.isObject(s) ? s : {},
      n = _.isFunction(a) ? a : _.isFunction(s) ? s : undefined;
    if (
      sd.para.heatmap &&
    ...
    if (sd.para.heatmap && sd.para.heatmap.custom_property) {
      ...
      _.isObject(d) && (o = _.extend(o, d));
    }
    (o = _.extend(o, i)),
      "a" === r && sd.para.heatmap && !0 === sd.para.heatmap.isTrackLink
        ? _.trackLink({ event: e, target: t }, "$WebClick", o)
        : sd.track("$WebClick", o, n);
  },
  hasElement: function(e) {
    var t = e._getPath
      ? e._getPath()
      : heatmap.getElementPath(e.target, !0).split(" > ");
  ...
  getCollectableParent: function(e, t) {
    try {
      ...
      var a =
        ...
        sd.para.heatmap.collect_tags.div &&
        sd.para.heatmap.collect_tags.div.max_level;
      if (s && "div" === s && (a > 1 || this.isCollectableDiv(r, t))) return r;
      ...
      t = (function(e) {
        ...
        func: function(e, t) {
          ...
          ((a > sd.para.heatmap.scroll_delay_time &&
            ...
            t) &&
            ((e.$url = _.isDecodeURI(sd.para.url_is_decode, location.href)),
...
(sd.unlimitedDiv = {
  ...
  isTargetEle: function(e) {
    ...
    if (!_.isObject(t) || !_.isString(t.$element_path)) return !1;
    for (var r = 0; r < this.events.length; r++)
      if (
        _.isObject(this.events[r]) &&
        _.isObject(this.events[r].event) &&
  ...
  (sd.customProp = {
    ...
    clickCustomPropMaker: function(e, t, r) {
      var s = this,
        a = ((r =
          r || this.filterConfig(e, t, sd.vtrackcollect.url_info.page_url)),
        {});
      return r.length
        ? (_.each(r, function(t) {
            _.isArray(t.properties) &&
              t.properties.length > 0 &&
              _.each(t.properties, function(t) {
                var r = s.getProp(t, e);
                _.isObject(r) && _.extend(a, r);
              });
          }),
          a)
        : {};
    ...
    getProp: function(e, t) {
      if (!_.isObject(e)) return !1;
      if (!(_.isString(e.name) && e.name.length > 0))
        return (
          sd.log(
      ...
      if ("content" === e.method) {
        var i;
        if (_.isString(e.element_selector) && e.element_selector.length > 0)
          i = _.getDomBySelector(e.element_selector);
        else {
          if (!_.isString(e.list_selector))
            return (
              sd.log(
          ...
          var n = _.getDomBySelector(t.properties.$element_selector);
          if (!n)
            return (
              sd.log(
          ...
          i = this.getPropElInLi(o, e.list_selector);
        }
        if (!i || !_.isElement(i))
          return (
            sd.log(
        ...
        if ("input" === i.tagName.toLowerCase()) r = i.value || "";
          ...
          _.isNumber(d) &&
            _.isElement(i[d]) &&
            (r = sd._.getElementContent(i[d], "select"));
        } else r = _.getElementContent(i, i.tagName.toLowerCase());
        if (e.regular) {
          try {
    ...
    getPropElInLi: function(e, t) {
      if (!(e && _.isElement(e) && _.isString(t))) return null;
      if ("li" !== e.tagName.toLowerCase()) return null;
      var r,
        s = sd.heatmap.getDomSelector(e);
      if (s) {
        r = s + t;
        var a = _.getDomBySelector(r);
        return a || null;
      }
      return (
        sd.log(
    ...
    filterConfig: function(e, t, r) {
      var s = [];
      if (!r) {
        var a = sd.vtrackcollect.initUrl();
        if (!a) return [];
        r = a.page_url;
      }
      return (
        "$WebClick" === e.event &&
          _.each(t, function(t, a) {
            _.isObject(t) &&
              ...
              sd.vtrackcollect.configIsMatch(e.properties, t.event) &&
              s.push(t);
          }),
        s
      );
  ...
  (sd.vtrackcollect = {
    ...
    initUrl: function() {
      ...
      try {
        (e = _.URL(sd.para.server_url)),
          (s.server_url.project = e.searchParams.get("project") || "default"),
          (s.server_url.host = e.host);
      } catch (a) {
        return (
          sd.log("----vtrackcollect---server_url\u89e3\u6790\u5f02\u5e38", a),
          !1
        );
      }
      try {
        (t = _.URL(location.href)),
          (s.page_url.host = t.hostname),
          (s.page_url.pathname = t.pathname);
      } catch (a) {
        return (
          sd.log(
      ...
      try {
        ((r = new _.urlParse(sd.para.server_url))._values.Path =
      ...
      return (this.url_info = s), s;
    },
    init: function() {
      if (!_.isObject(sd.para.heatmap) || !sd.para.heatmap.get_vtrack_config)
        return !1;
      if (
        (_.localStorage.isSupport() || (this.storageEnable = !1),
        !this.initUrl())
      )
        return (
          sd.log(
      ...
      if (this.storageEnable) {
        var e = _.localStorage.parse(this.storage_name);
        if (_.isObject(e) && _.isObject(e.data))
          if (this.serverUrlIsSame(e.serverUrl)) {
            ...
            if (_.isNumber(t) && t > 0 && t < this.para.session_time) {
    ...
    pageStateListenner: function() {
      ...
      _.listenPageState({
        visible: function() {
          ...
          if (_.isNumber(t) && t > 0 && t < e.para.update_interval) {
    ...
    updateStorage: function(e) {
      ...
      _.localStorage.set(this.storage_name, JSON.stringify(s));
    },
    ...
    getAssignConfigs: function(e, t) {
      ...
      return (
        ...
        _.isObject(t) && _.isArray(t.events) && t.events.length > 0
          ? (_.each(t.events, function(t) {
              _.isObject(t) &&
                _.isObject(t.event) &&
                t.event.url_host === r.url_info.page_url.host &&
                t.event.url_path === r.url_info.page_url.pathname &&
                e(t) &&
                s.push(t);
            }),
            s)
    ...
    isDiv: function(e) {
      if (e.element_path) {
        ...
        if ("div" !== _.trim(t.pop()).slice(0, 3)) return !1;
      }
      return !0;
    },
    configIsMatch: function(e, t) {
      ...
      } else if (sd.vtrackcollect.isDiv({ element_path: t.element_path })) {
...
_.each(methods, function(e) {
  ...
  sd[e] = function() {
    if (sd.readyState.state < 3)
      return _.isArray(sd._q) || (sd._q = []), sd._q.push([e, arguments]), !1;
